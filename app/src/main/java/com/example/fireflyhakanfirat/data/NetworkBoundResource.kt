...
@MainThread constructor(private val appExecutors: AppExecutors) {
    ...
    private fun fetchFromNetwork(dbSource: LiveData<ResultType>) {
        val apiResponse = createCallCasted()
                ...
                is ApiSuccessResponse -> {
                    appExecutors.diskIO().execute {
                        ...
                        appExecutors.mainThread().execute {
                            ...
                            result.addSource(loadFromDbCasted()) { newData ->
                                setValue(Resource.success(newData))
                            }
                        }
                    }
    ...
    private fun loadFromDbCasted(): LiveData<ResultType> = loadFromDb() as LiveData<ResultType>

    private fun createCallCasted(): LiveData<ApiResponse<RequestType>> = createCall() as LiveData<ApiResponse<RequestType>>
